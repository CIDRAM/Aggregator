...
if (!file_exists(__DIR__ . '/ipv4-1k-output.txt')) {
...
echo 'Average time: ' . ($Average / 3) . " seconds\n";
if (!file_exists(__DIR__ . '/ipv6-1k-output.txt')) {
...
echo 'Average time: ' . ($Average / 3) . " seconds\n";
if (!file_exists(__DIR__ . '/ipv4-5k-output.txt')) {
...
echo 'Average time: ' . ($Average / 3) . " seconds\n";
if (!file_exists(__DIR__ . '/ipv6-5k-output.txt')) {
...
echo 'Average time: ' . ($Average / 3) . " seconds\n";
if (!file_exists(__DIR__ . '/ipv4-10k-output.txt')) {
...
echo 'Average time: ' . ($Average / 3) . " seconds\n";
if (!file_exists(__DIR__ . '/ipv6-10k-output.txt')) {
